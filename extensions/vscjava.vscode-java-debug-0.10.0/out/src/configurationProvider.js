...
class JavaDebugConfigurationProvider {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (config.request === "launch") {
                    ...
                    if (!config.mainClass) {
                        const userSelection = yield this.chooseMainClass(folder);
    ...
    chooseMainClass(folder) {
        return __awaiter(this, void 0, void 0, function* () {
            const res = yield resolveMainClass(folder ? folder.uri : undefined);
            if (res.length === 0) {
                vscode.window.showErrorMessage("Cannot find a class with the main method.");
                return undefined;
            }
            ...
            const selection = pickItems.length > 1 ?
                yield vscode.window.showQuickPick(pickItems, { placeHolder: "Select main class<project name>" })
                : pickItems[0];
