    ...
    function showTroubleshootingDialog(errorMessage) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (choiceForDetails === OPTION_LEARN_MORE) {
                // open FAQs
                const readmeFilePath = Utils_1.Utils.getPathToExtensionRoot("Troubleshooting.md");
                vscode_1.commands.executeCommand("markdown.showPreview", vscode_1.Uri.file(readmeFilePath));
            }
        });
    }
