...
function registerCommand(context, commandName, func) {
    context.subscriptions.push(vscode_extension_telemetry_wrapper_1.TelemetryWrapper.registerCommand(commandName, (args) => __awaiter(this, void 0, void 0, function* () {
        try {
            yield func(args);
        }
        catch (error) {
