...
(function (Routines) {
    ...
    (function (GenerateProject) {
        ...
        const STEP_GROUPID_MESSAGE = "Input Group Id for your project. (Step 1/4)\t";
        const STEP_ARTIFACTID_MESSAGE = "Input Artifact Id for your project. (Step 2/4)\t";
        const STEP_BOOTVERSION_MESSAGE = "Specify Spring Boot version. (Step 3/4)";
        const STEP_DEPENDENCY_MESSAGE = "Search for dependencies. (Step 4/4)";
        ...
        function run(projectType) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const groupId = yield VSCodeUI_1.VSCodeUI.getFromInputBox({
                ...
                const artifactId = yield VSCodeUI_1.VSCodeUI.getFromInputBox({
                ...
                do {
                    current = yield vscode.window.showQuickPick(manager.getQuickPickItems(bootVersion.id, { hasLastSelected: true }), { ignoreFocusOut: true, placeHolder: STEP_DEPENDENCY_MESSAGE, matchOnDetail: true, matchOnDescription: true });
                ...
                yield vscode.window.withProgress({ location: vscode.ProgressLocation.Window }, (p) => new Promise((resolve, _reject) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    const targetUrl = `${Utils_1.Utils.settings.getServiceUrl()}/starter.zip?type=${projectType}&language=${language.toLowerCase()}&groupId=${groupId}&artifactId=${artifactId}&bootVersion=${bootVersion.id}&dependencies=${current.id}`;
