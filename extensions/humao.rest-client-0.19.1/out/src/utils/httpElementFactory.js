    ...
    static getHttpElements(document, line) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const { name, value } of requestVariables) {
                ...
                originalElements.push(new httpElement_1.HttpElement(name, httpElement_1.ElementType.RequestCustomVariable, '^\\s*[^@]', v, new vscode_1.SnippetString(`{{${name}.\${1|request,response|}.\${2|headers,body|}.\${3:Header Name, JSONPath or XPath}}}`)));
            }
